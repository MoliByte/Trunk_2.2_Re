...
public class DongTaiAdapter extends BaseAdapter implements HttpAysnResultInterface {
		...
		public void onClick(View v) {
			...
			case R.id.LinearLayoutSupport:
				...
				try{
					new PostHomePraiseService(context,
							...
							DongTaiAdapter.this).doPraise(userEntity.getToken(), "userPraise",
			...
			case R.id.LinearLayoutCollect:
				...
				try{
					...
					new PostHomeCollectService(context,HttpTagConstantUtils.POST_HOME_COLLECT,DongTaiAdapter.this).doCollect(userEntity.getToken(),
	...
	public boolean isLogin(){
    	...
    	if(userEntity != null &&userEntity.getToken()!=null&&!userEntity.getToken().equals("")){
    		return true ;
    	}else{
    		return false ;
    	}
