 ...
 *
 */
public class GetActionCommentListAsynTaskService implements HttpAysnTaskInterface{
	
	private final static String TAG = "GetCommentListAsynTaskService-->";
	private final static String ROOT = "object" ;
	private Context context;
	private Integer mTag;// Action 标签
	private HttpAysnResultInterface callback ;
	
	public GetActionCommentListAsynTaskService(Context context, Integer mTag,HttpAysnResultInterface callback) {
	 ...
	 * @param pageIndex
	 */
	public void doCommentsList(long id,int pageIndex) {
		try {
			...
			client.get(context, mTag,v1_post_url,params, GetActionCommentListAsynTaskService.this);
		} catch (Exception e) {
	 ...
	 * @return
	 */
	public ArrayList<ActionCommentEntity> parseJsonObject(Object result){
		try {
			JSONObject obj = new JSONObject(result.toString()) ;
			JSONArray comments = obj.optJSONArray("items");
			ArrayList<ActionCommentEntity> commentList = new ArrayList<ActionCommentEntity>();
